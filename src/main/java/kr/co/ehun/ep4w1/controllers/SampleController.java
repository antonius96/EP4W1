package kr.co.ehun.ep4w1.controllers;

import kr.co.ehun.ep4w1.domain.sample.child.ChildSample;
import kr.co.ehun.ep4w1.domain.sample.child.ChildSampleService;
import kr.co.ehun.ep4w1.domain.sample.child.ChildSampleVO;
import kr.co.ehun.ep4w1.domain.sample.parent.ParentSample;
import kr.co.ehun.ep4w1.domain.sample.parent.ParentSampleService;
import kr.co.ehun.ep4w1.domain.sample.parent.ParentSampleVO;
